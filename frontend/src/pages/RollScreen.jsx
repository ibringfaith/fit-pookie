  ...
  return (
    ...
    {/* <div className = "grid grid-flow-col auto-cols-max">
      ...
      <div className = "grid grid-rows-2 auto-cols-max">
        <HangerButton iconSize="size-1/16" padSize = "" onClick= {() => navigate('/WardrobeScreen')}/>
      </div>
      <img className="size-1/2 mx-auto object-contain" src={slotMachineCrop} alt="Slot Machine" />
    </>
  )
}